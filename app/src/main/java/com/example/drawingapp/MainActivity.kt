...
class MainActivity : AppCompatActivity() {
    ...
    val storageResultLauncher:ActivityResultLauncher<Array<String>> =
        registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()){
            ...
            permissions.entries.forEach {
                ...
                if (isGranted) {
                    Toast.makeText(this@MainActivity, "Permission granted for storage.", Toast.LENGTH_LONG)
                        .show()
                    ...
                    if (permissionName==Manifest.permission.READ_EXTERNAL_STORAGE) {
                        Toast.makeText(this@MainActivity, "Permission denied for storage.", Toast.LENGTH_LONG).show()
                    }
                }
            }
        }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val linearLayoutColors=findViewById<LinearLayout>(R.id.llColors)

        mCurrentPaint=linearLayoutColors[1]as ImageButton
        mCurrentPaint!!.setImageDrawable(ContextCompat.getDrawable(this,R.drawable.pallet_pressed))
        ...
        val btnStoragePermission:ImageButton=findViewById(R.id.ibFile)
    ...
    private fun requestStoragePermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,Manifest.permission.READ_EXTERNAL_STORAGE)) {
            ...
            storageResultLauncher.launch(arrayOf(Manifest.permission.READ_EXTERNAL_STORAGE,Manifest.permission.WRITE_EXTERNAL_STORAGE))
        }
    }
    ...
    fun colorClicked(view:View){
        if (view!=mCurrentPaint){
            ...
            mCurrentPaint?.setImageDrawable(ContextCompat.getDrawable(this,R.drawable.pallet_normal))
            mCurrentPaint=view
        }
    }
